...
const Garden = () => {
  return (
    <div className="flex grid-cols-1 h-[630px] items-center justify-center mt-[80px]">
      ...
      <div className="w-[600px] h-[600px] ml-[30px] mt-[20px]">
        ...
        <div className="grey-scale-3 font-manrope-medium w-[526px] h-[90px] text-lg mt-[40px]">
          ...
          dui. Pellentesque venenatis sem non lacus ac auctor.
        </div>
