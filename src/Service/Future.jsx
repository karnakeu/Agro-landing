...
const Future = () => {
  ...
  return (
    <div>
      <div
        className="relative w-full h-[616px] flex items-center"
        ...
        <div className="relative z-10  flex justify-between">
          ...
          <div className=" absolute flex mt-[130px] ml-[200px]  cursor-pointer ">
            <img
              src={video}
              alt="Play Video"
              className="w-[100px] h-[100px] cursor-pointer ml-[1000px]"
            />
          </div>
        </div>
        <span className="orange text-2xl  z-10 font-covered  h-[30px] mt-[300px] ml-[385px]">
          Watch our video
        </span>
      </div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute top-0  transform  w-[370px] h-[70px] bg-white rounded-top-lg  shadow-lg">
                <h3 className="text-lg font-manrope-extrabold px-20 py-4">
                  {card.title}
                </h3>
              </div>
            </div>
