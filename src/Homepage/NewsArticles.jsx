...
import Image1 from "/src/assets/news/1.svg";
import Image2 from "/src/assets/news/2.svg";
import Image3 from "/src/assets/news/3.svg";
import Image4 from "/src/assets/news/4.svg";
import Image5 from "/src/assets/news/5.svg";

const NewsArticles = () => {
  return (
    <section>
      <div className="flex flex-col items-center justify-center text-center mt-[113px]">
        <div className="font-covered orange text-[24px]">From the Blog</div>
      ...
      <div className="bg-grey-scale-9 w-full h-[255px] mt-[120px]"></div>
    </section>
  );
};
